#ifndef ALGO_CPP_BST_MAPPER_HPP
#define ALGO_CPP_BST_MAPPER_HPP
...
namespace algo::cpp::ds::tests::utils {
    ...
    template<>
    class Mapper<TreeNode*> {
    public:
        TreeNode* to_object(boost::json::value& json) {
