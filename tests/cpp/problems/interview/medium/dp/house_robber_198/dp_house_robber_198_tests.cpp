...
using namespace algo::interview::medium::dp::house_robber;

namespace algo::interview::medium::dp::house_robber::test {

    class DpHouseRobberTests : public ::testing::Test {
    protected:
        void SetUp() override {}
    ...
    TEST_F(DpHouseRobberTests, LeetCodeSample1) {
        run_test_case({1, 2, 3, 1}, 4);
    }

    TEST_F(DpHouseRobberTests, LeetCodeSample2) {
        run_test_case({2, 7, 9, 3, 1}, 12);
    }


    TEST_F(DpHouseRobberTests, RunTestsFromResource) {
