...
<strong>Explanation:</strong> From the center of the image with position (sr, sc) = (1, 1) (i.E_., the red pixel), all pixels connected by a path of the same color as the starting pixel (i.E_., the blue pixels) are colored with the new color.
...
<div><div>Related Topics</div><div><li>Array</li><li>TreeDepth-First Search</li><li>Breadth-First Search</li><li>Vector2D</li></div></div><br><div><li>👍 4894</li><li>👎 478</li></div>